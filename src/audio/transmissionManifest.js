const GENERAL_TRANSMISSIONS = [
    ...
    "./transmissions/gossip1.mp3",
    "./transmissions/gossip2.mp3",
    "./transmissions/gossip3.mp3",
    "./transmissions/gossip4.mp3",
    "./transmissions/gossip5.mp3",
    "./transmissions/gossip6.mp3",
    "./transmissions/gossip7.mp3"
];
...
const DEFAULT_MANIFEST = {
    ...
    health: {
        warning: [
            "./transmissions/health/warning/health1.mp3",
            "./transmissions/health/warning/health2.mp3",
            "./transmissions/health/warning/health3.mp3",
            "./transmissions/health/warning/health4.mp3",
            "./transmissions/health/warning/health5.mp3",
            "./transmissions/health/warning/health6.mp3",
            "./transmissions/health/warning/health7.mp3",
            "./transmissions/health/warning/health8.mp3",
            "./transmissions/health/warning/health9.mp3",
            "./transmissions/health/warning/health10.mp3",
            "./transmissions/health/warning/health11.mp3",
            "./transmissions/health/warning/health12.mp3",
            "./transmissions/remember_your_training.mp3",
            "./transmissions/coms-are-on.mp3"
        ],
        critical: [
            "./transmissions/health/critical/critical1.mp3",
            "./transmissions/health/critical/critical2.mp3",
            "./transmissions/health/critical/critical3.mp3",
            "./transmissions/health/critical/critical4.mp3",
            "./transmissions/health/critical/critical5.mp3",
            "./transmissions/health/critical/critical6.mp3",
            "./transmissions/health/critical/critical7.mp3",
            "./transmissions/health/critical/critical8.mp3",
            "./transmissions/health/critical/critical9.mp3",
            "./transmissions/health/critical/critical10.mp3",
            "./transmissions/health/critical/critical11.mp3",
            "./transmissions/health/critical/critical12.mp3",
            "./transmissions/health/critical/critical13.mp3",
            "./transmissions/health/critical/critical14.mp3",
            "./transmissions/can_we_have.mp3",
            "./transmissions/survival_odds.mp3"
        ]
    },
    ...
    wave: {
        intermission: [
            ...
            "./transmissions/wave/new/new_wave1.mp3",
            "./transmissions/wave/new/new_wave2.mp3",
            "./transmissions/wave/new/new_wave3.mp3",
            "./transmissions/wave/new/new_wave4.mp3",
            "./transmissions/wave/new/new_wave5.mp3",
        ...
        mid: [
            "./transmissions/wave/midle/mid1.mp3",
            "./transmissions/wave/midle/mid2.mp3",
            "./transmissions/wave/midle/mid3.mp3",
            "./transmissions/wave/midle/mid4.mp3",
            "./transmissions/wave/midle/mid5.mp3"
        ],
        success: [
            ...
            "./transmissions/wave/clear/wave_clear1.mp3",
            "./transmissions/wave/clear/wave_clear2.mp3",
            "./transmissions/wave/clear/wave_clear3.mp3",
            "./transmissions/wave/clear/wave_clear4.mp3",
            "./transmissions/wave/clear/wave_clear5.mp3",
            "./transmissions/wave/clear/wave_clear6.mp3",
            "./transmissions/wave/clear/wave_clear7.mp3",
            "./transmissions/wave/clear/wave_clear8.mp3",
            "./transmissions/wave/clear/wave_clear9.mp3",
            "./transmissions/wave/clear/wave_clear10.mp3"
        ]
    },
    milestone: {
        rankUp: [
            ...
            "./transmissions/brass_says.mp3",
            "./transmissions/combat_performance.mp3",
            "./transmissions/rankup/rank_up1.mp3",
            "./transmissions/rankup/rank_up2.mp3",
            "./transmissions/rankup/rank_up3.mp3",
            "./transmissions/rankup/rank_up4.mp3",
            "./transmissions/rankup/rank_up5.mp3"
        ],
        synergy: [
            "./transmissions/fun_fact.mp3",
            "./transmissions/remember_your_training.mp3",
            "./transmissions/morele_report.mp3",
            "./transmissions/synergies/synergy1.mp3",
            "./transmissions/synergies/synergy2.mp3",
            "./transmissions/synergies/synergy3.mp3",
            "./transmissions/synergies/synergy4.mp3"
        ],
        victory: [
            "./transmissions/good_news.mp3",
            "./transmissions/your-at_5.mp3",
            "./transmissions/victory/victory1.mp3",
            "./transmissions/victory/victory2.mp3",
            "./transmissions/victory/victory3.mp3"
        ],
        defeat: [
            "./transmissions/survival_odds.mp3",
            "./transmissions/quiet_war.mp3",
            "./transmissions/quarantine.mp3",
            "./transmissions/defeat/defeat1.mp3",
            "./transmissions/defeat/defeat2.mp3",
            "./transmissions/defeat/defeat2-2.mp3",
            "./transmissions/defeat/defeat3.mp3"
        ]
    }
};
...
function mergeManifest(manifest) {
    ...
    for (const section of ["health", "enemies", "upgrades", "bosses", "wave", "milestone"]) {
